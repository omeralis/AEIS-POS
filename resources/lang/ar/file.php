...
return [
	...
	"Cheque" => "الشيك",
	"Cancel" => "إلغاء",
	"Recent transaction" => "العمليات الاخيرة",
	"Invoice" => "فاتورة",
	"Shipping" => "الشحن",
	...
	"Biller List" => "قائمة معدين الفواتير",
	"Add Biller" => "أضف معد فاتورة",
	...
	"Stock Count" => " مخزون المستودع ",
	"Count Stock" => " اطلب تفرير ",
	"Full" => "ممتلئ",
	...
	"Sale Generated" => " عملية بيع",
	"Purchase Generated" => " عملية شراء",
