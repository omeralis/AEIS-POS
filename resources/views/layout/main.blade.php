          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <span class="brand-big">
                <img src="{{url('public/logo','WhatsApp Image 2020-12-29 at 11.49.15 PM.jpeg')}}" width="100">
              &nbsp;&nbsp;
              {{--@if($general_setting->site_logo)
              <img src="{{url('public/logo', $general_setting->site_logo)}}" width="50">
              &nbsp;&nbsp;
              @endif--}}
              <a href="{{url('/')}}"><h1 class="d-inline">
    ...
    <div class="page">
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <p>&copy; {{$general_setting->site_title}} | {{trans('file.Developed')}} {{trans('file.By')}} <a href="https://sahlowle.github.io" class="external">Suhail Osman</a></p>
            </div>
          </div>
        </div>
      </footer>
