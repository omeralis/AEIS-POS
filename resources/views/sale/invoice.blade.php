...
<div style="max-width:400px;margin:0 auto">
    ...
    <div id="receipt-data">
        ...
        <p>{{trans('file.Date')}}: {{$lims_sale_data->created_at}}<br>
            ...
            {{trans('file.customer')}}: {{ isset($lims_customer_data) ?$lims_customer_data->name:"" }}
        </p>
        <table>
            <tbody>
        ...
        <p>{{trans('file.Developed By')}}</p>
        <!-- <div class="centered" style="margin:30px 0 50px">
            <small>
            {{trans('file.Developed By')}}  <a href="http://sahlowle.github.io" class="external">Suhail Os</a></strong></small>
        </div> -->
    </div>
</div>
