            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="payment-options">
                        ...
                        <div class="column-5">
                            <button style="background: #00cec9" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="cash-btn"><i class="fa fa-money"></i> {{ __('file.Cash') }}</button>
                        </div>
                        {{-- <div class="column-5">
                        ...
                        <div class="column-5">
                            <button style="background-color: #fd7272" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="cheque-btn"><i class="fa fa-money"></i>  {{ __('file.Cheque') }} </button>
                        </div>
                        {{-- <div class="column-5">
                        ...
                        <div class="column-5">
                            <button style="background-color: #d63031;" type="button" class="btn btn-custom" id="cancel-btn" onclick="return confirmCancel()"><i class="fa fa-close"></i>{{ __('file.Cancel') }}</button>
                        </div>
                        <div class="column-5">
                            <button style="background-color: #ffc107;" type="button" class="btn btn-custom" data-toggle="modal" data-target="#recentTransaction"><i class="dripicons-clock"></i> {{ __('file.Recent transaction') }}</button>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td> {{ isset($customer) ? $customer->name : "" }} </td>
