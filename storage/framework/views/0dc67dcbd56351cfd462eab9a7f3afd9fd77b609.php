...
<div style="max-width:400px;margin:0 auto">
    ...
    <div id="receipt-data">
        ...
        <p><?php echo e(trans('file.Date')); ?>: <?php echo e($lims_sale_data->created_at); ?><br>
            ...
            <?php echo e(trans('file.customer')); ?>: <?php echo e(isset($lims_customer_data) ?$lims_customer_data->name:""); ?>
        ...
        <p><?php echo e(trans('file.Developed By')); ?></p>
        <!-- <div class="centered" style="margin:30px 0 50px">
            <small>
            <?php echo e(trans('file.Developed By')); ?>  <a href="http://sahlowle.github.io" class="external">Suhail Os</a></strong></small>
        </div> -->
    </div>
</div>
