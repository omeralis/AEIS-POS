            ...
            <div class="col-md-6">
                <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php endif; ?>
                                            <select  id="biller_id" name="biller_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Biller...">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group pos">
                                                ...
                                                <select name="customer_id" id="customer_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select customer..." style="width: 100px">
                                                <?php $deposit = [] ?>
                    ...
                    <div class="payment-options">
                        ...
                        <div class="column-5">
                            <button style="background: #00cec9" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="cash-btn"><i class="fa fa-money"></i> <?php echo e(__('file.Cash')); ?></button>
                        </div>
                        
                        
                        <div class="column-5">
                            <button style="background-color: #fd7272" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="cheque-btn"><i class="fa fa-money"></i>  <?php echo e(__('file.Cheque')); ?> </button>
                        </div>
                        
                        
                        <div class="column-5">
                            <button style="background-color: #d63031;" type="button" class="btn btn-custom" id="cancel-btn" onclick="return confirmCancel()"><i class="fa fa-close"></i><?php echo e(__('file.Cancel')); ?></button>
                        </div>
                        <div class="column-5">
                            <button style="background-color: #ffc107;" type="button" class="btn btn-custom" data-toggle="modal" data-target="#recentTransaction"><i class="dripicons-clock"></i> <?php echo e(__('file.Recent transaction')); ?></button>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td> <?php echo e(isset($customer) ? $customer->name : ""); ?> </td>
...
function addNewProduct(data){
    ...
    if(keyboard_active==1){
        ...
        if (!customer_group_rate !== undefined) {
