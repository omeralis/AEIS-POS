...
<html>
  ...
  <body onload="myFunction()" class="droid-arabic-naskh">
    <div id="loader"></div>
      <!-- Side Navbar -->
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <span class="brand-big">
                <img src="<?php echo e(url('public/logo','WhatsApp Image 2020-12-29 at 11.49.15 PM.jpeg')); ?>" width="100">
              &nbsp;&nbsp;
              
              <a href="<?php echo e(url('/')); ?>"><h1 class="d-inline">
    ...
    <div class="page">
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <p>&copy; <?php echo e($general_setting->site_title); ?> | <?php echo e(trans('file.Developed')); ?> <?php echo e(trans('file.By')); ?> <a href="https://sahlowle.github.io" class="external">Suhail Osman</a></p>
            </div>
          </div>
        </div>
      </footer>
